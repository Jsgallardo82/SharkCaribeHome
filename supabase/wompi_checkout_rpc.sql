-- ============================================================
-- Shark Caribe 2026 · Checkout Wompi vía RPC (sin Edge Function)
-- Evita el 403 CloudFront en /functions/v1 desde el navegador.
-- Ejecutar en el SQL Editor de Supabase.
--
-- IMPORTANTE: reemplaza el valor de integrity_secret abajo con tu
-- secreto de integridad Sandbox (test_integrity_…) o prod.
-- ============================================================
...
-- >>> EDITA ESTE VALOR con tu secreto de integridad de Wompi <<<
...
COMMENT ON FUNCTION public.create_attendee_wompi_checkout(jsonb) IS
  'Crea inscripción de asistente + firma Wompi (integrity) sin exponer el secreto al cliente.';
